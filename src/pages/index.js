    ...
    return (
      <div>
          ...
          <div className={'foss-container'}>
            ...
            <Row className={'sec-row-wrapper-section-advancement'}>
              <Col
                ...
                md={12}
                lg={3}
                className={'left-section-advancement'}
              >
                <hr className={'left-line'}></hr>
                <p className={'advancement-left-content'}>
                  India is well positioned to become a vibrant hub for FOSS
                  innovations. In India, 4G data subscribers have recently
                  crossed more than 598 million of which 96% of them access the
                  digital world via open-source based mobile operating systems
                </p>
                <hr className={'left-line'}></hr>
              </Col>
                ...
                <div className={'advancement-right'}>
                  ...
                  <div>
                    <p className={'advancement-right-content'}>
                      ...
                      and “open-source software”, which despite describing
                      similar ownership models, have differing cultures and
                      philosophies.
                      <br />
                      <br></br>
                      The“free software” model advocated by the Free Software
                      Foundation focuses on the fundamental freedoms a software
                      must give to its users, commonly explained as “think of
        ...
        <Row className="foss-opportunities-section">
          <div className="foss-container">
            <div className={'index-card index-card-absolute hide-text-md'}>
              02
            </div>
            <Col sm={12}>
              <Row>
                ...
                <Col sm={12} md={12} lg={4}>
                  ...
                  <Card background_color="#01BCD5">
                    <ul>
                      ...
                      <li>
                        Onboard more users by delivering digital services in
          ...
          <Col sm={12} className="foss-categories-body">
            <Row>
              <Row className={'foss-categories-text'}>
                <Col sm={12} md={12} lg={5} className={'left-col'}>
                  ...
                  <h4 className={'about-advancement hide-text-lg'}>
                    Based on our conversations and reading, we classified the
                    FOSS movement into six eras mentioned here
                  </h4>
                </Col>
              </Row>
              <h4 className={'about-advancement-bottom hide-text-md'}>
                Based on our conversations and reading, we classified the FOSS
                movement into six eras mentioned here
              </h4>
              <Col
                sm={12}
                md={12}
                lg={2}
                style={{ backgroundColor: '#FFDFD5' }}
              >
              ...
              <Col
                ...
                md={12}
                lg={2}
                style={{ backgroundColor: '#E2EED5' }}
              >
                <div className="categories-folder">
                  <Folder
                    className="categories-folder"
                    background_color="white"
                    caption="1978 - 1989"
                    wrapperType={'timeline-folder'}
              ...
              >
                ...
                <Row
                  className={'categories-folder-rcontainer'}
                  style={{ backgroundColor: '#66FFD5' }}
                >
                  <Col sm={12} md={12} lg={{ span: 4, offset: 2 }}>
                    <div className="categories-folder-col">
                      <Folder
                        background_color="white"
                        caption="1999 - present"
                        wrapperType={'timeline-folder'}
                        captionClass={'present-caption'}
                        handleClick={() =>
                          this.showModal('global-proliferation')
                        }
                      >
                        <div className={'normal-folder'}>
                ...
                <Row
                  className={'categories-folder-rcontainer'}
                  style={{ backgroundColor: '#FFD78F' }}
                >
                  <Col sm={12} md={12} lg={{ span: 4, offset: 2 }}>
                    <div className="categories-folder-col">
                      <Folder
                        background_color="white"
                        caption="2001 - present"
                        wrapperType={'timeline-folder'}
                        captionClass={'present-caption'}
            ...
            <Row>
              ...
              <Col sm={12} md={8} lg={8} className={'right-col'}>
                <p className={'right-text-ecosystem'}>
                  ...
                  research institutes, online educational actors, micro small
                  and medium tech enterprises, global tech firms, local and
                  state governments, national governments, FOSS funders and FOSS
                  investors.
                </p>
              </Col>
            </Row>
            ...
            <Col sm={12} className="foss-focusarea-body">
              <Row>
                <Col md={3} lg={2} style={{ left: '-3%' }}>
                  <Folder
                    background_color="#FFDDD6"
                    handleClick={() => this.showModal('page-foss-communities')}
                  >
                ...
                <Col md={3} lg={{ span: 2, offset: 1 }} style={{ left: '-3%' }}>
                  <Folder
                    background_color="#FFD8FC"
                    handleClick={() => this.showModal('page-foss-education')}
                  >
                    <div className={'another-normal-folder'}>
                      <p>FOSS & Education</p>
                    </div>
                ...
                <Col md={3} lg={{ span: 2, offset: 1 }} style={{ left: '-3%' }}>
                  <Folder
                    background_color="#FCFFE0"
                    handleClick={() => this.showModal('page-foss-business')}
                  >
                    <div className={'another-normal-folder'}>
                      <p>FOSS & Business</p>
                    </div>
                ...
                <Col md={3} lg={{ span: 2, offset: 1 }} style={{ left: '-3%' }}>
                  <Folder
                    background_color="#AAD3FF"
                    handleClick={() => this.showModal('page-foss-government')}
                  >
                    <div className={'another-normal-folder'}>
                      <p>FOSS & Government</p>
                    </div>
            ...
            <Row>
              <Col sm={12} md={12} lg={4} className={'left-col'}>
                <h2 className={'text-left'}>
                  Sustained Collaborat&shy;ions to Build Future Pathways for
                  FOSS in India
                </h2>
              </Col>
              <Col sm={8} className={'right-col'}>
                <p className={'first-last-block-1'}>
                  The current pandemic has amplified FOSS’s importance due to
                  the movement’s ability to bring diverse actors together to
                  build, localize and deploy crisis response solutions
                  effectively
                </p>
                <hr />
                ...
                <Row>
                  <p className={'last-block '}>
                    A strategic investment in growing the FOSS ecosystem will
                    not only help us onboard the next half billion internet
                    ...
                    <Folder background_color="white">
                      <div className={'download-folder'}>
                        ...
                        <p>
                          <a
                            className="foss-link"
                            href="/the-state-of-foss-report-executive-summary.pdf"
                            target="_blank"
                          >
                            Executive Summary
                          </a>
                    ...
                    <Folder background_color="white">
                      <div className={'download-folder'}>
                        ...
                        <p>
                          <a
                            className="foss-link"
                            href="/the-state-of-foss-report.pdf"
                            target="_blank"
                          >
                            Full Report
                          </a>
          ...
          <div className={'foss-container'}>
            ...
            <Row>
              <Col sm={12} lg={8}>
                <p className={'about-us-left-content'}>
                  <br />
                  <span>CivicDataLab</span> works with the goal to use data,
                  tech, design and social science to strengthen the course of
                  civic engagements in India. We work to harness the potential
                  of open-source movement to enable citizens to engage better
                  with public reforms. We aim to grow data and tech literacy of
                  governments, nonprofits, think tanks, media houses,
                  universities etc to enable data-driven decision making at
                  scale.
                </p>
              </Col>
            </Row>
            <Row>
              ...
              <Col sm={12} lg={4} className={'ONI-section'}>
                <p className={'about-us-right-content'}>Supported By</p>
                <img
        ...
        <Row className="foss-footer-section">
          <div className="foss-container">
            ...
            <Col className={'footer-cc'}>
              <div className={'foss-cc-by-content'}>
                The State of FOSS in India by
                <a
