            ...
            <Row>
              <Col sm={6}>
                <p className={'about-us-left-content'}>
                  ...
                  social science to strengthen the course of civic engagements
                  in India. We work to harness the potential of open-source
                  movement to enable citizens to engage better with public
                  reforms. We aim to grow data and tech literacy of governments,
                  nonprofits, think tanks, media houses, universities etc to
              ...
              <Col sm={6}>
                <p className={'about-us-right-content'}>
                  ...
                  ranging from the poorest among us to the existing middle
                  class. To drive empowerment and social impact at scale, we
                  work with entrepreneurs in the private, non-profit and public
                  sectors, who are tackling India’s hardest and most chronic
                  problems.
                </p>
                <img
