...
export default class FolderFocusArea extends Component {
    ...
    this.page_map = {
      ...
      "page-foss-business": [page_foss_biz_one, page_foss_biz_three, page_foss_biz_two, <FocusAreaContentBuiss />],
      "page-foss-government": [page_foss_gov_one, page_foss_gov_three, page_foss_gov_two, <FocusAreaContentGov />]
    }
  }
